...
const menuList = [
  {
    ...
    icon: 'bilibili',
    handler: () => {
      window.open('https://b23.tv/NMSMxsu0', '_blank')
    },
  },
  {
    name: '后端源码',
    desc: 'HaoChatWeb Server',
    icon: 'github',
    handler: () => {
      window.open('https://github.com/PLzzz-373/HaoChat', '_blank')
    },
  },
  {
    name: '前端源码',
    ...
    icon: 'github',
    handler: () => {
      window.open('https://github.com/PLzzz-373/HaoChatWeb', '_blank')
    },
  },
]
</script>
